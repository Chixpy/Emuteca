...
uses
  ...
  IniFiles, sha1, LazUTF8, LazFileUtils,
  uCHXStrUtils, uCHXFileUtils, uaCHXStorable,
  uEmutecaCommon, ucEmutecaPlayingStats, uaEmutecaCustomSoft;
...
begin
  ...
  begin
    ...
    RegisterMethod(
      'Procedure SearchAllRelatedFiles( OutFileList : TStrings; aFolder : string; Extensions : TStrings; AutoExtract : boolean)');
    RegisterMethod(
      'Function SearchFirstRelatedFile( aFolder : string; Extensions : TStrings; AutoExtract : boolean) : string');
...
procedure caEmutecaCustomSoftYear_W(Self: caEmutecaCustomSoft;
  const T: string);
begin
  Self.Year := T;
end;
...
procedure caEmutecaCustomSoftSortTitle_W(Self: caEmutecaCustomSoft;
  const T: string);
begin
  Self.SortTitle := T;
end;

procedure caEmutecaCustomSoftSortTitle_R(Self: caEmutecaCustomSoft;
  var T: string);
begin
  T := Self.SortTitle;
end;

procedure caEmutecaCustomSoftTranslitTitle_W(Self: caEmutecaCustomSoft;
  const T: string);
begin
  Self.TranslitTitle := T;
end;

procedure caEmutecaCustomSoftTranslitTitle_R(Self: caEmutecaCustomSoft;
  var T: string);
begin
  T := Self.TranslitTitle;
end;

procedure caEmutecaCustomSoftTitle_W(Self: caEmutecaCustomSoft;
  const T: string);
begin
  Self.Title := T;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@caEmutecaCustomSoft.GetActualSortTitle,
      'GetActualSortTitle');
    RegisterMethod(@caEmutecaCustomSoft.GetActualTranslitTitle,
    ...
    RegisterVirtualMethod(@caEmutecaCustomSoft.SearchAllRelatedFiles,
      'SearchAllRelatedFiles');
    RegisterVirtualMethod(@caEmutecaCustomSoft.SearchFirstRelatedFile,
      'SearchFirstRelatedFile');
    RegisterPropertyHelper(@caEmutecaCustomSoftID_R,
      @caEmutecaCustomSoftID_W, 'ID');
    ...
    RegisterPropertyHelper(@caEmutecaCustomSoftTitle_R,
      @caEmutecaCustomSoftTitle_W, 'Title');
    RegisterPropertyHelper(@caEmutecaCustomSoftTranslitTitle_R,
      @caEmutecaCustomSoftTranslitTitle_W, 'TranslitTitle');
    RegisterPropertyHelper(@caEmutecaCustomSoftSortTitle_R,
      @caEmutecaCustomSoftSortTitle_W, 'SortTitle');
    RegisterPropertyHelper(@caEmutecaCustomSoftVersion_R,
      @caEmutecaCustomSoftVersion_W, 'Version');
    RegisterPropertyHelper(@caEmutecaCustomSoftYear_R,
      @caEmutecaCustomSoftYear_W, 'Year');
