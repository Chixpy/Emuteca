...
begin
 ...
 CL.AddConstantN('krsIniKeyEmulatorsFile','String').SetString( 'EmulatorsFile');
 CL.AddConstantN('krsIniKeyAutoSysFolders','String').SetString( 'AutoSysFolders');
 CL.AddConstantN('krsIniKeySystemsFile','String').SetString( 'SystemsFile');
 CL.AddConstantN('krsIniKeySysDataFolder','String').SetString( 'SysDataFolder');
 CL.AddConstantN('krsIniKeyTagsFolder','String').SetString( 'TagsFolder');
 CL.AddConstantN('krsIniSecTools','String').SetString( 'Tools');
 CL.AddConstantN('krsIniKey7zCMExecutable','String').SetString( '7zCMExecutable');
 CL.AddConstantN('krsIniKey7zGExecutable','String').SetString( '7zGExecutable');
 CL.AddConstantN('krsIniSecExtensions','String').SetString( 'Extensions');
 CL.AddConstantN('krsIniKeyCompressedExtensions','String').SetString( 'CompressedExtensions');
 CL.AddConstantN('krsIniSecTemp','String').SetString( 'Temp');
 CL.AddConstantN('krsIniKeyTempSubfolder','String').SetString( 'TempSubfolder');
...
begin
  ...
  begin
    ...
    RegisterPropertyHelper(@cEmutecaConfigAutoSysFolder_R,@cEmutecaConfigAutoSysFolder_W,'AutoSysFolder');
    RegisterPropertyHelper(@cEmutecaConfigTagsFolder_R,@cEmutecaConfigTagsFolder_W,'TagsFolder');
    ...
    RegisterPropertyHelper(@cEmutecaConfigMinPlayTime_R,@cEmutecaConfigMinPlayTime_W,'MinPlayTime');
