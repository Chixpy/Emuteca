...
begin
 ...
 CL.AddConstantN('krsCSVStatsHeader','String').SetString( '"Last Time","Times Played","Playing Time"');
 CL.AddConstantN('krsCSVSoftHeader','String').SetString( '"Group","SHA1","ID","Folder","FileName",' + '"Title","TransliteratedName","SortTitle","Version","Year","Publisher",' + '"Zone","DumpStatus","DumpInfo","Fixed","Trainer","Translation",' + '"Pirate","Cracked","Modified","Hack"');
 CL.AddConstantN('krsCSVGroupHeader','String').SetString( '"ID","Title","Year","Developer"');
 ...
 CL.AddConstantN('krsIniKeyWorkingFolder','String').SetString( 'WorkingFolder');
 ...
 CL.AddConstantN('krsIniKeyMusicCaptions','String').SetString( 'MusicCaptions');
 CL.AddConstantN('krsIniKeyVideoFolders','String').SetString( 'VideoFolders');
 CL.AddConstantN('krsIniKeyVideoCaptions','String').SetString( 'VideoCaptions');
 CL.AddConstantN('krsIniKeySoftExportKey','String').SetString( 'SoftExportKey');
 ...
 CL.AddConstantN('krsIniKeyTranslitTitl','String').SetString( 'TranslitTitle');
 ...
 CL.AddConstantN('rsImportingSystemList','String').SetString( 'Importing system list...');
 CL.AddConstantN('rsSavingSystemList','String').SetString( 'Saving system list...');
 CL.AddConstantN('rsLoadingSoftList','String').SetString( 'Loading soft list...');
 CL.AddConstantN('rsImportingSoftList','String').SetString( 'Importing soft list...');
 CL.AddConstantN('rsSavingSoftList','String').SetString( 'Saving soft list...');
 CL.AddConstantN('rsLoadingGroupList','String').SetString( 'Loading group list...');
 CL.AddConstantN('rsImportingGroupList','String').SetString( 'Importing group list...');
 CL.AddConstantN('rsSavingGroupList','String').SetString( 'Saving group list...');
 ...
 CL.AddConstantN('rsFileAlreadyAdded','String').SetString( 'This file is already added.');
  CL.AddTypeS('TEmutecaSoftExportKey', '( TEFKSHA1, TEFKCRC32, TEFKFileName, TE'
   +'FKCustom )');
 ...
 CL.AddDelphiFunction('Function Str2EmutecaSoftExportKey( aString : string) : TEmutecaSoftExportKey');
 CL.AddDelphiFunction('Function EmutecaSoftExportKey2StrK( aSOK : TEmutecaSoftExportKey) : string');
 CL.AddDelphiFunction('Function Key2EmutecaDumpSt( aString : string) : TEmutecaDumpStatus');
 CL.AddDelphiFunction('Function EmutecaDumpSt2Key( aEDS : TEmutecaDumpStatus) : string');
 CL.AddDelphiFunction('Function EmutecaDumpSt2Str( aEDS : TEmutecaDumpStatus) : string');
 CL.AddDelphiFunction('Function EmutecaDumpSt2StrK( aEDS : TEmutecaDumpStatus) : string');
 CL.AddDelphiFunction('Procedure EmuTKSearchAllRelatedFiles( OutFileList : TStrings; aFolder : string; aFileName : string; Extensions : TStrings; SearchInComp : boolean; DecompressFolder : string)');
 CL.AddDelphiFunction('Function EmuTKSearchFirstRelatedFile( aFolder : string; aFileName : string; Extensions : TStrings; SearchInComp : boolean; AutoDecompress : boolean; DecompressFolder : string) : string');
 CL.AddDelphiFunction('Procedure EmuTKSearchAllFilesByNameExtCT( aFileList : TStrings; aBaseFileName : string; aExtList : string)');
 CL.AddDelphiFunction('Procedure EmuTKSearchAllFilesByNameExtSL( aFileList : TStrings; aBaseFileName : string; aExtList : TStrings)');
 CL.AddDelphiFunction('Function EmuTKSearchFirstFileByNameExtCT( aBaseFileName : string; aExtList : string) : string');
 CL.AddDelphiFunction('Function EmuTKSearchFirstFileByNameExtSL( aBaseFileName : string; aExtList : TStrings) : string');
end;
...
procedure RIRegister_uEmutecaCommon_Routines(S: TPSExec);
begin
 S.RegisterDelphiFunction(@Str2EmutecaSoftExportKey, 'Str2EmutecaSoftExportKey', cdRegister);
 S.RegisterDelphiFunction(@EmutecaSoftExportKey2StrK, 'EmutecaSoftExportKey2StrK', cdRegister);
 S.RegisterDelphiFunction(@Key2EmutecaDumpSt, 'Key2EmutecaDumpSt', cdRegister);
 S.RegisterDelphiFunction(@EmutecaDumpSt2Key, 'EmutecaDumpSt2Key', cdRegister);
 S.RegisterDelphiFunction(@EmutecaDumpSt2Str, 'EmutecaDumpSt2Str', cdRegister);
 S.RegisterDelphiFunction(@EmutecaDumpSt2StrK, 'EmutecaDumpSt2StrK', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchAllRelatedFiles, 'EmuTKSearchAllRelatedFiles', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchFirstRelatedFile, 'EmuTKSearchFirstRelatedFile', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchAllFilesByNameExtCT, 'EmuTKSearchAllFilesByNameExtCT', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchAllFilesByNameExtSL, 'EmuTKSearchAllFilesByNameExtSL', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchFirstFileByNameExtCT, 'EmuTKSearchFirstFileByNameExtCT', cdRegister);
 S.RegisterDelphiFunction(@EmuTKSearchFirstFileByNameExtSL, 'EmuTKSearchFirstFileByNameExtSL', cdRegister);
end;
...
begin
  RIRegister_uEmutecaCommon_Routines(CompExec.Exec); // comment it if no routines
end;
(*----------------------------------------------------------------------------*)
